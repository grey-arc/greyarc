...
export default function ContactsAdmin() {
  ...
  const filtered = useMemo(() => {
    ...
    return contacts.filter((c) => {
      return (
        ...
        (c.publishedAt && c.publishedAt.toLowerCase().includes(q))
      );
    });
  }, [contacts, query]);
  ...
  function exportCSV() {
    const headers = ["title", "author", "published", "publishedAt", "visits"];
      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          <DateCard
            ...
            heading="Blog Posts"
            mainStat={blogStats.totalBlogs}
            description="Blogs in Totals"
            heightFlag={true}
          />
          ...
          <DateCard
            ...
            heading="Visitors"
            mainStat={blogStats.sum}
            description="Total Blogs Visitors"
            heightFlag={true}
          />
        </div>
        ...
        <Card className="h-fit bg-white p-4 space-y-4 rounded-2xl mt-6">
          <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <Input
                placeholder="Search name, author, published, pblished date or visits..."
                value={query}
                onChange={(e) => {
                ...
                <Table>
                  ...
                  <TableFooter>
                    <TableRow>
                      ...
                      <TableCell>{blogStats.sum}</TableCell>
                    </TableRow>
                  </TableFooter>
                </Table>
              </ScrollArea>
