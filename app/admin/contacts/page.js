      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
          <DateCard
            ...
            mainStat={contactStats.contactsToday}
            description="Forms Filled Today"
            heightFlag={true}
          />

          <DateCard
            icon={
              <MessageSquareDot className="w-8 h-8 text-gray-700 stroke-[1.5]" />
            }
            mainStat={contactStats.contactsLast7Days}
            description="Forms Filled in Last 7 Days"
            heightFlag={true}
          />
          ...
          <DateCard
            ...
            mainStat={contactStats.contactsThisMonth}
            description="Forms Filled This Month"
            heightFlag={true}
          />

          <DateCard
            icon={<Database className="w-8 h-8 text-gray-700 stroke-[1.5]" />}
            mainStat={contactStats.totalContacts}
            description="Forms Filled Overall"
            heightFlag={true}
          />
        </div>
